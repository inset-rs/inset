...
impl Pacing {
    ...
    /// is when one is wanted and none was drawn in this interval. Stops the ticks after a
    /// few refreshes with nothing wanted.
    ...
    /// A frame was drawn in this interval, whatever asked for it.
