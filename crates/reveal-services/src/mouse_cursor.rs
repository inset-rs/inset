...
use reveal_embedder::{Platform, SystemMouseCursorKind};
use reveal_gestures::PointerEvent;
...
mod tests {
    ...
    use reveal_embedder::InertPlatform;
    use reveal_gestures::{PointerHoverEvent, PointerRemovedEvent};
    ...
    impl Platform for RecordingPlatform {
        ...
        fn view(&self, _id: reveal_embedder::ViewId) -> Option<reveal_embedder::ViewRef> {
            None
        }
