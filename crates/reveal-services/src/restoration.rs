...
pub use reveal_embedder::{RestorationData, RestorationMap, RestorationUpdate};
...
///
/// [`add_listener`]: reveal_foundation::ListenableObject::add_listener
#[derive(Default)]
...
mod tests {
    ...
    use reveal_foundation::{ListenableObject, Listener};
