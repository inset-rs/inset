...
use reveal_painting::{AnyColor, BoxDecoration, EdgeInsetsGeometry, TextStyle};
use reveal_widgets::{
...
mod tests {
    ...
    use reveal_rendering::{AnyRenderObject, RenderClipRRect, RenderHandle, RenderObject};
    ...
    fn probe(seen: &Rc<RefCell<Vec<reveal_painting::TextStyle>>>) -> Builder {
        let seen = Rc::clone(seen);
        Builder::new(move |app, context| {
            seen.borrow_mut()
                .push(reveal_widgets::DefaultTextStyle::of(app, context).style);
