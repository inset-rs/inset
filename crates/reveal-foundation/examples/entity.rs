//! User stores: [`Entity`], [`notify`](reveal_foundation::Context::notify), and
//! [`emit`](reveal_foundation::Context::emit). Run with:
//!
//! ```text
//! cargo run -p reveal-foundation --example entity
//! ```

use reveal_foundation::{AppCell, Context, EventEmitter};
