...
use inset_embedder::{BlendMode, Canvas, ClipOp, Paint};
use inset_embedder::{Offset, Path, PathBuilder, Rect, Size};
    ...
    fn paint_shadows(
        ...
        for box_shadow in box_shadow {
            ...
            if cfg!(debug_assertions)
                ...
                && box_shadow.blur_style == inset_embedder::BlurStyle::Outer
            {
                canvas.save();
...
mod tests {
    ...
    use inset_embedder::{FillRule, Radius, lerp_double};
