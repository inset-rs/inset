...
use inset_embedder::{Canvas, FillRule, Path, PathBuilder, RRect};
...
pub struct BeveledRectangleBorder {
    ...
    ///
    /// Each corner [`Radius`](inset_embedder::Radius) defines the endpoints of
...
mod tests {
    use super::*;
    use inset_embedder::{Color, Radius};
