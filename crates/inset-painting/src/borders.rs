...
use inset_embedder::{Canvas, FillRule, Paint, PaintStyle, Path, PathBuilder, Stroke};
use inset_embedder::{Color, Offset, Rect, lerp_double};
...
mod tests {
    ...
    fn to_paint_stroke_and_none() {
        ...
        assert_eq!(paint1.blend_mode, inset_embedder::BlendMode::SrcOver);
        ...
        assert_eq!(paint2.blend_mode, inset_embedder::BlendMode::SrcOver);
    }
