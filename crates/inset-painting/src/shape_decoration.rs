...
use inset_embedder::{BlurStyle, Canvas, ClipOp, FillRule, Matrix4, Offset, Paint};
use inset_embedder::{Path, PathBuilder, Rect, Size};
...
mod tests {
    ...
    use inset_embedder::{FillRule, Radius};
