...
pub struct PlaceholderDimensions {
    ...
    pub alignment: inset_embedder::PlaceholderAlignment,
...
impl PlaceholderDimensions {
    ...
    pub const EMPTY: PlaceholderDimensions = PlaceholderDimensions {
        size: Size::ZERO,
        alignment: inset_embedder::PlaceholderAlignment::Bottom,
    ...
    pub const fn new(
        size: Size,
        alignment: inset_embedder::PlaceholderAlignment,
...
impl TextPainter {
    ...
    fn debug_paint_character_layout_boxes(&mut self, canvas: &mut Canvas, offset: Offset) {
        ...
        for text_box in text_boxes {
            let host_rect: inset_embedder::valo::Rect = text_box.to_rect().shift(offset).into();
