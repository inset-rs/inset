...
use reveal_gestures::DragDirection;
use reveal_gestures::{
...
use reveal_rendering::{AnyRenderBox, CustomPainter};
...
fn shapes_equal(a: Option<&dyn OutlinedBorder>, b: Option<&dyn OutlinedBorder>) -> bool {
    match (a, b) {
        (None, None) => true,
        (Some(a), Some(b)) => {
            a as &dyn reveal_painting::ShapeBorder == b as &dyn reveal_painting::ShapeBorder
        }
        _ => false,
    }
}
...
macro_rules! raw_scrollbar_setters {
    ($name:ident) => {
        ...
        /// Dart `shape:`.
        pub fn shape(mut self, shape: Box<dyn reveal_painting::OutlinedBorder>) -> $name {
        ...
        /// Dart `radius:`.
        pub fn radius(mut self, radius: reveal_embedder::Radius) -> $name {
        ...
        /// Dart `thumbColor:`.
        pub fn thumb_color(mut self, thumb_color: reveal_embedder::Color) -> $name {
        ...
        /// Dart `trackRadius:`.
        pub fn track_radius(mut self, track_radius: reveal_embedder::Radius) -> $name {
            self.raw_scrollbar.track_radius = Some(track_radius);
            self
        }

        /// Dart `trackColor:`.
        pub fn track_color(mut self, track_color: reveal_embedder::Color) -> $name {
            self.raw_scrollbar.track_color = Some(track_color);
            self
        }

        /// Dart `trackBorderColor:`.
        pub fn track_border_color(mut self, track_border_color: reveal_embedder::Color) -> $name {
        ...
        /// Dart `padding:`.
        pub fn padding(mut self, padding: reveal_painting::EdgeInsetsGeometry) -> $name {
