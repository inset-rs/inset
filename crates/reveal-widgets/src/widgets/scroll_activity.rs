...
use reveal_scheduler::TickerProvider;
...
pub trait ScrollActivity: Sized + 'static {
    ...
    /// [`reveal_rendering::ScrollDirection::Idle`].
    ///
    /// See also:
    ///
...
/// touch has become a [`reveal_gestures::Drag`].
///
...
/// See also:
///
///  * [`ScrollDragController`], which listens to the [`reveal_gestures::Drag`] and actually scrolls
///    the scroll view.
