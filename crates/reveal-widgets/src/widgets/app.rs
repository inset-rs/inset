...
use reveal_embedder::{Clip, Color, Locale, TargetPlatform};
use reveal_foundation::{App, Handle, K_IS_WEB, Listenable};
use reveal_painting::{AxisDirection, TextStyle};
...
pub struct WidgetsApp {
    ...
    ///
    /// Defaults to [`Platform::default_route_name`](reveal_embedder::Platform::default_route_name),
