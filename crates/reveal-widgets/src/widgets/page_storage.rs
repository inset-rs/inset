...
use reveal_foundation::{App, Handle, Key, LocalKey};
...
impl PageStorageKey {
    ...
    pub fn new<T: PartialEq + Hash + fmt::Debug + 'static>(value: T) -> PageStorageKey {
        PageStorageKey {
            value: Rc::new(reveal_foundation::ValueKey::new(value)),
        }
    }
...
mod tests {
    ...
    fn without_keys_nothing_is_saved_and_identifiers_are_direct() {
        ...
        let identifier: KeyRef = Rc::new(reveal_foundation::ValueKey::new("scroll"));
