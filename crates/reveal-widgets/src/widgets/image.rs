...
use reveal_embedder::{ImageDecodeError, Size, TextDirection};
...
use reveal_rendering::{AnyRenderObject, RenderBox, RenderHandle, RenderImage};
...
mod image_widget_tests {
    use reveal_painting::ImageProvider;
    ...
    use reveal_foundation::AppCell;
    use reveal_rendering::RenderImage;
    ...
    struct TestCodec {
        ...
        asked: Rc<Cell<u32>>,
        dropped: Rc<Cell<u32>>,
        frame_gate: Option<reveal_foundation::CompleterFuture<()>>,
    }
    ...
    struct TestHost {
        ...
        asked: Rc<Cell<u32>>,
        dropped: Rc<Cell<u32>>,
        open_gate: Option<reveal_foundation::CompleterFuture<()>>,
        frame_gate: Option<reveal_foundation::CompleterFuture<()>>,
    }
    ...
    fn finish_frame(app: &mut App) {
        reveal_scheduler::SchedulerBinding::handle_begin_frame(app, Some(Duration::ZERO));
    ...
    fn late_open_and_frame_results_release_their_codec_after_stream_disposal() {
        for delay_open in [true, false] {
            let gate = reveal_foundation::Completer::new();
            ...
            let completer;
            {
                ...
                let cache = reveal_painting::ImageCache::instance(&mut app);
                cache.clear(&mut app);
