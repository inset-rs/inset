...
/// [`Listenable`](reveal_foundation::Listenable).
///
...
/// A base for a [`RestorableProperty`] that stores and restores a
/// [`ChangeNotifier`](reveal_foundation::ChangeNotifier).
///
...
mod tests {
    ...
    use reveal_services::{RestorationBucket, RestorationManager, RestorationMap};
