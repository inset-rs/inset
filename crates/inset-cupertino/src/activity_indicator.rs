...
use inset_animation::{Animation, AnimationBehavior, AnimationController, AnyAnimation};
use inset_embedder::{Canvas, Color, Offset, Paint, RRect, Radius, Size, clamp_double};
use inset_foundation::{App, Handle, Listenable};
use inset_painting::{AnyColor, BorderRadius, draw_rrect};
...
mod tests {
    ...
    use inset_widgets::{Align, GlobalKey};
    ...
    fn drawn<T>(
        ...
        size: Size,
        of: impl Fn(&inset_embedder::Paint, inset_embedder::valo::Rect) -> T,
    ) -> Vec<T> {
