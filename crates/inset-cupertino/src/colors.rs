...
//! by an [`AnyColor`] whose value is the effective color (see inset-painting's
...
use inset_embedder::{Brightness, Color};
use inset_foundation::App;
use inset_painting::{AnyColor, ColorExtension};
use inset_widgets::{BuildContext, MediaQuery};
...
mod tests {
    ...
    use inset_widgets::{Builder, IntoWidget, MediaQuery, MediaQueryData, SizedBox, WidgetRef};
