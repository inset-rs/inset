...
use inset_embedder::{Canvas, Color, ImageFilter, Offset, Paint, Rect, TextDirection};
use inset_foundation::{App, CompleterFuture, Handle, Listener, ValueNotifier};
use inset_gestures::{
...
use inset_painting::{AlignmentGeometry, AnyColor, BoxPainter, Decoration, ImageConfiguration};
use inset_physics::{Simulation, SpringDescription, SpringSimulation, Tolerance};
use inset_rendering::{HitTestBehavior, ImageFilterConfig, StackFit};
...
/// The `Route` overrides a [`CupertinoRouteTransitionMixin`] leaf inherits: `inset-widgets`'
...
macro_rules! cupertino_route_transition_mixin_route_overrides {
    () => {
        ...
        fn as_modal_route(
            self: ::inset_foundation::Handle<Self>,
        ) -> ::std::option::Option<::inset_widgets::AnyModalRoute> {
            ::std::option::Option::Some(::inset_widgets::ModalRoute::as_modal_route(self))
        }

        fn as_page_route(
            self: ::inset_foundation::Handle<Self>,
        ) -> ::std::option::Option<::inset_widgets::AnyPageRoute> {
            ::std::option::Option::Some(::inset_widgets::PageRoute::as_page_route(self))
        }
        ...
        fn overlay_entries(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
        ) -> ::std::vec::Vec<::inset_foundation::Handle<::inset_widgets::OverlayEntry>> {
            ::inset_widgets::OverlayRoute::overlay_entries(self, app)
        }

        fn install(self: ::inset_foundation::Handle<Self>, app: &mut ::inset_foundation::App) {
            ::inset_widgets::ModalRoute::install(self, app)
        }

        fn did_push(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
        ) -> ::inset_scheduler::TickerFuture {
            ::inset_widgets::ModalRoute::did_push(self, app)
        }

        fn did_add(self: ::inset_foundation::Handle<Self>, app: &mut ::inset_foundation::App) {
            ::inset_widgets::ModalRoute::did_add(self, app)
        }

        fn did_replace(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            old_route: ::std::option::Option<::inset_widgets::AnyRoute>,
        ) {
            ::inset_widgets::TransitionRoute::did_replace(self, app, old_route)
        }

        fn will_pop(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
        ) -> ::inset_widgets::RoutePopDisposition {
            ::inset_widgets::LocalHistoryRoute::will_pop(self, app)
        }
        ...
        fn pop_disposition(
            ...
            ::inset_widgets::ModalRoute::pop_disposition(self, app)
        }
        ...
        fn on_pop_invoked_with_result(
            ...
            app: &mut ::inset_foundation::App,
            did_pop: bool,
            result: ::inset_widgets::RouteResult,
        ) {
            ::inset_widgets::ModalRoute::on_pop_invoked_with_result(self, app, did_pop, result)
        }
        ...
        fn will_handle_pop_internally(
            ...
            ::inset_widgets::LocalHistoryRoute::will_handle_pop_internally(self, app)
        }
        ...
        fn did_pop(
            ...
            ::inset_widgets::LocalHistoryRoute::did_pop(self, app, result)
        }

        fn did_pop_next(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            next_route: ::inset_widgets::AnyRoute,
        ) {
            ::inset_widgets::ModalRoute::did_pop_next(self, app, next_route)
        }

        fn did_change_next(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            next_route: ::std::option::Option<::inset_widgets::AnyRoute>,
        ) {
            ::inset_widgets::ModalRoute::did_change_next(self, app, next_route)
        }

        fn did_change_previous(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            previous_route: ::std::option::Option<::inset_widgets::AnyRoute>,
        ) {
        ...
        fn changed_internal_state(
            ...
            ::inset_widgets::ModalRoute::changed_internal_state(self, app)
        }
        ...
        fn changed_external_state(
            ...
            ::inset_widgets::ModalRoute::changed_external_state(self, app)
        }

        fn dispose(self: ::inset_foundation::Handle<Self>, app: &mut ::inset_foundation::App) {
...
/// `inset-widgets`' `modal_transition_route_overrides!`. Write it inside
...
macro_rules! cupertino_route_transition_mixin_transition_route_overrides {
    () => {
        ::inset_widgets::modal_transition_route_overrides!();

        fn allow_snapshotting(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
        ) -> bool {
            ::inset_widgets::PageRoute::allow_snapshotting(self, app)
        }
        ...
        fn can_transition_to(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
            next_route: ::inset_widgets::AnyTransitionRoute,
        ) -> bool {
        ...
        fn can_transition_from(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
            previous_route: ::inset_widgets::AnyTransitionRoute,
        ) -> bool {
...
/// `inset-widgets`' `modal_route_accessors!`. Write it inside
...
macro_rules! cupertino_route_transition_mixin_modal_route_overrides {
    () => {
        ::inset_widgets::modal_route_accessors!();

        fn barrier_dismissible(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
        ) -> bool {
            ::inset_widgets::PageRoute::barrier_dismissible(self, app)
        }

        fn barrier_color(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
        ) -> ::std::option::Option<::inset_painting::Color> {
        ...
        fn build_page(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            context: ::inset_widgets::BuildContext,
            animation: ::inset_animation::AnyAnimation<f64>,
            secondary_animation: ::inset_animation::AnyAnimation<f64>,
        ) -> ::inset_widgets::WidgetRef {
...
impl OverlayRoute for CupertinoPageRoute {
    inset_widgets::modal_overlay_route_overrides!();
}

impl PredictiveBackRoute for CupertinoPageRoute {
    inset_widgets::page_predictive_back_route_overrides!();
}
...
impl LocalHistoryRoute for CupertinoPageRoute {
    inset_widgets::local_history_route_accessors!();
}
...
impl PageRoute for CupertinoPageRoute {
    inset_widgets::page_route_accessors!();
}
...
impl State for CupertinoBackGestureDetectorState {
    ...
    fn build(self: Handle<Self>, app: &mut App, context: BuildContext) -> WidgetRef {
        ...
        let child = self.widget(app).child.clone();
        let listener = inset_widgets::Listener::new()
...
impl Route for CupertinoModalPopupRoute {
    inset_widgets::modal_route_overrides!();
}
...
impl PredictiveBackRoute for CupertinoModalPopupRoute {
    inset_widgets::modal_predictive_back_route_overrides!(ModalRoute::pop_gesture_enabled);
}
...
impl TransitionRoute for CupertinoDialogRoute {
    inset_widgets::raw_dialog_route_transition_route_overrides!();
...
impl ModalRoute for CupertinoDialogRoute {
    inset_widgets::raw_dialog_route_modal_route_overrides!();
}

impl PopupRoute for CupertinoDialogRoute {}

impl RawDialogRouteLeaf for CupertinoDialogRoute {
    inset_widgets::raw_dialog_route_accessors!();
