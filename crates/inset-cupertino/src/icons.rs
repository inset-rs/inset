...
#[cfg(test)]
mod tests {
    use inset_embedder::{FontCollection, TextDirection};
    use inset_foundation::AppCell;
    use inset_painting::{TextPainter, TextSpan, TextStyle};
    ...
    fn latin_without_a_family_does_not_use_the_icon_font() {
        ...
        binding.install_fonts(&mut app, |fonts| {
            inset_embedder::set_default_font_manager(
                fonts,
                Box::new(inset_embedder::SystemFontSource::platform()),
            );
        });
        install_cupertino_icon_font(&mut app);
            ...
            TextSpan::new()
                ...
                .style(
                    TextStyle::new()
                        .inherit(false)
                        .font_size(14.0)
                        .font_weight(inset_embedder::FontWeight::W900),
                )
                .into_span(),
        ));
