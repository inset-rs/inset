...
use inset_embedder::{Canvas, Clip, Matrix4, Offset, Path, PathBuilder, RRect, Rect};
use inset_foundation::{App, Handle};
use inset_painting::{ClipContext, inverse_transform_rect};
...
mod tests {
    ...
    use inset_embedder::{Color, Paint, SceneBuilder, Size, valo::Op};
