...
use inset_embedder::{Matrix4, Offset, Rect, clamp_double};
use inset_foundation::{App, AsyncCallback, Handle, HandleId, ListenableObject, Listener};
use inset_painting::{Axis, AxisDirection, transform_rect};
        ...
        let controller = match self.floating_data(app).controller {
            ...
            None => {
                let controller = AnimationController::create(
                    ...
                    0.0,
                    1.0,
                    inset_animation::AnimationBehavior::Normal,
                    vsync,
                );
...
mod tests {
    ...
    use inset_foundation::{AppCell, Task};
