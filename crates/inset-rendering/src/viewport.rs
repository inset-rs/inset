...
use inset_embedder::{Clip, Matrix4, Offset, Rect, Size, clamp_double};
use inset_foundation::{App, Handle, HandleId, Listenable, Listener};
    ...
    RenderBox + RenderAbstractViewport + ContainerRenderObjectMixin<ChildType = AnyRenderSliver>
{
    ...
    fn did_attach(
        self: RenderHandle<Self>,
        app: &mut App,
        owner: inset_foundation::Handle<PipelineOwner>,
    ) {
...
fn viewport_offset_changed<T: RenderViewportBase>(
    this: inset_foundation::Handle<T>,
    app: &mut App,
) {
