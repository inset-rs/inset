...
use inset_embedder::{Rect, clamp_double};
...
use inset_physics::{Tolerance, near_equal};
use inset_rendering::{
...
impl ScrollPositionBase {
    ...
    pub fn move_to<P: ScrollPosition>(
        ...
        inset_rendering::ViewportOffsetBase::move_to(this, app, to, duration, curve, Some(clamp))
    }
