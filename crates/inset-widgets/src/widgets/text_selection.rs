...
impl ParentData for ToolbarItemsParentData {
    fn detach(&mut self) {
        inset_rendering::ContainerParentDataMixin::detach(self);
    }
...
impl inset_rendering::ContainerParentDataMixin for ToolbarItemsParentData {
...
impl LiveTextInputStatusNotifier {
    ...
    pub fn update(self: Handle<Self>, app: &mut App) {
        ...
        let next_status = if inset_services::LiveText::is_live_text_input_available(app) {
