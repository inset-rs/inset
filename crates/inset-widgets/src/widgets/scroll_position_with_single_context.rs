...
use inset_physics::near_equal;
use inset_rendering::{ScrollDirection, ViewportOffset};
...
macro_rules! scroll_position_with_single_context_viewport_offset_overrides {
    () => {
        fn pixels(self: ::inset_foundation::Handle<Self>, app: &::inset_foundation::App) -> f64 {
        ...
        fn animate_to(
            ...
            curve: ::std::rc::Rc<dyn ::inset_animation::Curve>,
        ) -> ::inset_foundation::CompleterFuture<()> {
        ...
        fn move_to(
            ...
            curve: ::std::option::Option<::std::rc::Rc<dyn ::inset_animation::Curve>>,
...
macro_rules! scroll_position_with_single_context_overrides {
    () => {
        ...
        fn hold(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            hold_cancel_callback: ::inset_foundation::Listener,
        ...
        fn drag(
            self: ::inset_foundation::Handle<Self>,
            app: &mut ::inset_foundation::App,
            details: ::inset_gestures::DragStartDetails,
            drag_cancel_callback: ::inset_foundation::Listener,
        ) -> ::std::rc::Rc<dyn ::inset_gestures::Drag> {
...
macro_rules! scroll_position_with_single_context_delegate_overrides {
    () => {
        ...
        fn go_idle(self: ::inset_foundation::Handle<Self>, app: &mut ::inset_foundation::App) {
