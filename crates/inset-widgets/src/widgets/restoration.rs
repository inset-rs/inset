...
pub use inset_services::RestorationBucket;
use inset_services::{RestorationData, RestorationManager};
...
impl AnyRestorableProperty {
    ...
    /// See [`Listenable::add_listener`](inset_foundation::Listenable::add_listener).
    pub fn add_listener(self, app: &mut App, listener: Listener) {
        (self.vtable.add_listener)(app, self.id, listener);
    }

    /// See [`Listenable::remove_listener`](inset_foundation::Listenable::remove_listener).
