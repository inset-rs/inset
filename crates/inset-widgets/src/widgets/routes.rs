...
use inset_scheduler::{FrameCallback, SchedulerBinding, SchedulerPhase, TickerFuture};
...
struct ModalScopeState {
    ...
    no_gesture_in_progress: Option<Handle<inset_foundation::ValueNotifier<bool>>>,
}
...
impl State for ModalScopeState {
    ...
    fn init_state(self: Handle<Self>, app: &mut App) {
        ...
        app.get_mut(self).no_gesture_in_progress =
            Some(app.create(inset_foundation::ValueNotifier::new(false)));
        let route = self.route(app);
        let animations: Vec<Option<Rc<dyn inset_foundation::Listenable>>> = vec![
            route
                .animation(app)
                .map(|animation| Rc::new(animation) as Rc<dyn inset_foundation::Listenable>),
            route
    ...
    fn build(self: Handle<Self>, app: &mut App, _context: BuildContext) -> WidgetRef {
        ...
        let gesture_notifier: Rc<dyn inset_foundation::Listenable> =
...
pub struct ModalRouteData {
    ...
    pub filter: Option<inset_rendering::ImageFilterConfig>,
...
macro_rules! modal_route_overrides {
    () => {
        ...
        fn overlay_entries(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
        ) -> ::std::vec::Vec<::inset_foundation::Handle<$crate::OverlayEntry>> {
...
macro_rules! modal_transition_route_overrides {
    () => {
        ...
        fn animation(
            self: ::inset_foundation::Handle<Self>,
            app: &::inset_foundation::App,
        ) -> ::std::option::Option<::inset_animation::AnyAnimation<f64>> {
...
macro_rules! raw_dialog_route_transition_route_overrides {
    () => {
        ...
        fn opaque(self: ::inset_foundation::Handle<Self>, app: &::inset_foundation::App) -> bool {
