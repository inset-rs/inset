...
/// example, [`crate::EdgeInsets`] is described in terms of top, left, right, and
/// bottom, while [`crate::EdgeInsetsDirectional`] is described in terms of top,
/// start, end, and bottom, where start and end correspond to right and left in
...
/// `TextAlign.start` and [`crate::EdgeInsetsDirectional`] start.
///
