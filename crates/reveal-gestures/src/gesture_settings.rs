...
/// See also:
///
///  * [`reveal_embedder::GestureSettings`], the configuration that this is derived from.
...
#[cfg(test)]
mod tests {
    use reveal_embedder::{GestureSettings, View, ViewId, ViewMetrics};
    ...
    impl View for SettingsView {
        ...
        fn present(&self, _picture: &reveal_embedder::Picture) {}
    }
