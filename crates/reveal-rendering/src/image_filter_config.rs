...
use reveal_embedder::{ImageFilter, Rect};
...
impl ImageFilterConfig {
    ...
    ///
    /// This is also how a [`reveal_embedder::ColorFilter`] is wrapped, since Dart's
...
#[cfg(test)]
mod tests {
    use reveal_embedder::{BlendMode, Color, ColorFilter};
